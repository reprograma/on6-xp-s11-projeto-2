...
const CreateProfile = () => {
    ...
    const onSubmit = (data,e) => {
        ...
        adicionar(body).then(data => {e.target.reset()})
    };

    async function adicionar(body) {
        const url = "http://localhost:5555/maravilhosas"
    ...
    return (
        ...
        <form className="edit-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button className="btn btn_roxo btn_center">Criar</button>
      </form>
      </div>
    )
}
